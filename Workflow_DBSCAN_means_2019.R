...
data <- mediterranean_sea %>%
  select(longitude, latitude, 
         environment.2019_land_distance,
         environment.2019_mean_depth,
         environment.2019_net_primary_production,
         environment.2019_sea.bottom_dissolved_oxygen,
         fishing.activity.2019_total_fishing,
         species.richness.2019,
         stocks.richness.2019,
         thermohalinity_2019)
...
##### DBSCAN #####
v <- data[, c("environment.2019_land_distance",
              "environment.2019_mean_depth",
              "environment.2019_net_primary_production",
              "environment.2019_sea.bottom_dissolved_oxygen",
              "fishing.activity.2019_total_fishing",
...
write.csv(data_with_clusters, file="./cluster_DBSCAN_2019.csv", row.names = FALSE)