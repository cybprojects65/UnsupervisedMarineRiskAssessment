...
data <- mediterranean_sea %>%
  select(longitude, latitude, 
         environment.2020_land_distance,
         environment.2020_mean_depth,
         environment.2020_net_primary_production,
         environment.2020_sea.bottom_dissolved_oxygen,
         fishing.activity.2020_total_fishing,
         species.richness.2020,
         stocks.richness.2020,
         thermohalinity_2020)
...
##### DBSCAN #####
v <- data[, c("environment.2020_land_distance",
              "environment.2020_mean_depth",
              "environment.2020_net_primary_production",
              "environment.2020_sea.bottom_dissolved_oxygen",
              "fishing.activity.2020_total_fishing",
...
write.csv(data_with_clusters, file="./cluster_DBSCAN_2020.csv", row.names = FALSE)